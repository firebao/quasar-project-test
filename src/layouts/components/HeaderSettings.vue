...
<template>
  <div class="q-pa-md">
    <q-btn-dropdown
      ...
      data-test="dropdown"
      :menu-offset="[0, 10]"
      :style="{ backgroundColor: theme.global.themeColor, color: 'white' }"
    >
      <q-list
      ...
      >
        <q-item
          ...
          v-close-popup
          data-test="theme"
          @click="isThemeDialogShow = true"
        >
          <q-item-section avatar>
            <q-icon name="fa-brands fa-themeisle"></q-icon>
          </q-item-section>
          <q-item-section>
            <q-item-label>主题管理</q-item-label>
          </q-item-section>
        </q-item>
        <q-item
          clickable
          v-close-popup
          data-test="log"
          @click="isLogDialogShow = true"
        >
          <q-item-section avatar>
            <q-icon name="fa fa-book-journal-whills"></q-icon>
          </q-item-section>
          <q-item-section>
